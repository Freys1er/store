// This is the central registry for all products in the store.
const products = [
    {
        pid: "CJSJ212415202BY", // Must match the backend secureProductList
        sku: "CJSJ212415202BY", // Must be the REAL SKU from CJdropshipping
